...
class ReturnsApi
{
     ...
     * @return \Swagger\Client\Model\ReturnsArrayV2
     */
    public function getReturns($from_date, $to_date, $page = '1', $limit = '80')
    {
        list($response) = $this->getReturnsWithHttpInfo($from_date, $to_date, $page, $limit);
        return $response;
    }
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\ReturnsArrayV2, HTTP status code, HTTP response headers (array of strings)
     */
    public function getReturnsWithHttpInfo($from_date, $to_date, $page = '1', $limit = '80')
    {
        $returnType = '\Swagger\Client\Model\ReturnsArrayV2';
        $request = $this->getReturnsRequest($from_date, $to_date, $page, $limit);
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\ReturnsArrayV2',
     ...
     */
    public function getReturnsAsync($from_date, $to_date, $page = '1', $limit = '80')
    {
        return $this->getReturnsAsyncWithHttpInfo($from_date, $to_date, $page, $limit)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getReturnsAsyncWithHttpInfo($from_date, $to_date, $page = '1', $limit = '80')
    {
        $returnType = '\Swagger\Client\Model\ReturnsArrayV2';
        $request = $this->getReturnsRequest($from_date, $to_date, $page, $limit);
     ...
     */
    protected function getReturnsRequest($from_date, $to_date, $page = '1', $limit = '80')
    {
        // verify the required parameter 'from_date' is set
        if ($from_date === null || (is_array($from_date) && count($from_date) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $from_date when calling getReturns'
            );
        }
        // verify the required parameter 'to_date' is set
        if ($to_date === null || (is_array($to_date) && count($to_date) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $to_date when calling getReturns'
            );
        }
    ...
    /**
     * Operation putReturns
     *
     * Inform us of an RMA
     *
     * @param  \Swagger\Client\Model\RmaRequestV2 $body RMA (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\RmaResponseV2
     */
    public function putReturns($body)
    {
        list($response) = $this->putReturnsWithHttpInfo($body);
        return $response;
    }

    /**
     * Operation putReturnsWithHttpInfo
     *
     * Inform us of an RMA
     *
     * @param  \Swagger\Client\Model\RmaRequestV2 $body RMA (required)
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\RmaResponseV2, HTTP status code, HTTP response headers (array of strings)
     */
    public function putReturnsWithHttpInfo($body)
    {
        $returnType = '\Swagger\Client\Model\RmaResponseV2';
        $request = $this->putReturnsRequest($body);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\RmaResponseV2',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
                case 202:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\Paths1returnsPutResponses201ContentApplication1jsonSchema',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function putReturnsAsync($body)
    {
        return $this->putReturnsAsyncWithHttpInfo($body)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation putReturnsAsyncWithHttpInfo
     *
     * Inform us of an RMA
     *
     * @param  \Swagger\Client\Model\RmaRequestV2 $body RMA (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function putReturnsAsyncWithHttpInfo($body)
    {
        $returnType = '\Swagger\Client\Model\RmaResponseV2';
        $request = $this->putReturnsRequest($body);
    ...
    /**
     * Create request for operation 'putReturns'
     *
     * @param  \Swagger\Client\Model\RmaRequestV2 $body RMA (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function putReturnsRequest($body)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling putReturns'
            );
        }
