...
class TrackingApi
{
     ...
     * @return \Swagger\Client\Model\TrackingResponse
     */
    public function getTrack($tracking_number = null)
    {
        list($response) = $this->getTrackWithHttpInfo($tracking_number);
        return $response;
    }
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\TrackingResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getTrackWithHttpInfo($tracking_number = null)
    {
        $returnType = '\Swagger\Client\Model\TrackingResponse';
        $request = $this->getTrackRequest($tracking_number);
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\TrackingResponse',
     ...
     */
    public function getTrackAsync($tracking_number = null)
    {
        return $this->getTrackAsyncWithHttpInfo($tracking_number)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getTrackAsyncWithHttpInfo($tracking_number = null)
    {
        $returnType = '\Swagger\Client\Model\TrackingResponse';
        $request = $this->getTrackRequest($tracking_number);
     ...
     */
    protected function getTrackRequest($tracking_number = null)
    {
