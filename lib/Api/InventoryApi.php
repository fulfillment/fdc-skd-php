...
class InventoryApi
{
     ...
     * @param  string[] $external_sku_names A CSV of sku reference names, &#x27;skuName1&#x27; or &#x27;skuName1,skuName2,skuName3&#x27; (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\ItemInventoryArrayV2
     */
    public function getInventory($page = '1', $limit = '80', $merchant_ids = null, $external_sku_names = null)
    {
        list($response) = $this->getInventoryWithHttpInfo($page, $limit, $merchant_ids, $external_sku_names);
        return $response;
    }
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\ItemInventoryArrayV2, HTTP status code, HTTP response headers (array of strings)
     */
    public function getInventoryWithHttpInfo($page = '1', $limit = '80', $merchant_ids = null, $external_sku_names = null)
    {
        $returnType = '\Swagger\Client\Model\ItemInventoryArrayV2';
        $request = $this->getInventoryRequest($page, $limit, $merchant_ids, $external_sku_names);
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\ItemInventoryArrayV2',
     ...
     */
    public function getInventoryAsync($page = '1', $limit = '80', $merchant_ids = null, $external_sku_names = null)
    {
        return $this->getInventoryAsyncWithHttpInfo($page, $limit, $merchant_ids, $external_sku_names)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getInventoryAsyncWithHttpInfo($page = '1', $limit = '80', $merchant_ids = null, $external_sku_names = null)
    {
        $returnType = '\Swagger\Client\Model\ItemInventoryArrayV2';
        $request = $this->getInventoryRequest($page, $limit, $merchant_ids, $external_sku_names);
     ...
     */
    protected function getInventoryRequest($page = '1', $limit = '80', $merchant_ids = null, $external_sku_names = null)
    {
        ...
        // query params
        if (is_array($external_sku_names)) {
            $external_sku_names = ObjectSerializer::serializeCollection($external_sku_names, 'csv', true);
        }
        if ($external_sku_names !== null) {
            $queryParams['externalSkuNames'] = ObjectSerializer::toQueryValue($external_sku_names, null);
        }
