...
class AuthApi
{
    ...
    /**
     * Operation postOauthAccessToken
     *
     * Generate an Access Token
     *
     * @param  \Swagger\Client\Model\AccessTokenRequestV2 $body Get an access token (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\AccessTokenResponseV2
     */
    public function postOauthAccessToken($body)
    {
        list($response) = $this->postOauthAccessTokenWithHttpInfo($body);
        return $response;
    }

    /**
     * Operation postOauthAccessTokenWithHttpInfo
     *
     * Generate an Access Token
     *
     * @param  \Swagger\Client\Model\AccessTokenRequestV2 $body Get an access token (required)
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\AccessTokenResponseV2, HTTP status code, HTTP response headers (array of strings)
     */
    public function postOauthAccessTokenWithHttpInfo($body)
    {
        $returnType = '\Swagger\Client\Model\AccessTokenResponseV2';
        $request = $this->postOauthAccessTokenRequest($body);
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\AccessTokenResponseV2',
    ...
    /**
     * Operation postOauthAccessTokenAsync
     *
     * Generate an Access Token
     *
     * @param  \Swagger\Client\Model\AccessTokenRequestV2 $body Get an access token (required)
     ...
     */
    public function postOauthAccessTokenAsync($body)
    {
        return $this->postOauthAccessTokenAsyncWithHttpInfo($body)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation postOauthAccessTokenAsyncWithHttpInfo
     *
     * Generate an Access Token
     *
     * @param  \Swagger\Client\Model\AccessTokenRequestV2 $body Get an access token (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postOauthAccessTokenAsyncWithHttpInfo($body)
    {
        $returnType = '\Swagger\Client\Model\AccessTokenResponseV2';
        $request = $this->postOauthAccessTokenRequest($body);
    ...
    /**
     * Create request for operation 'postOauthAccessToken'
     *
     * @param  \Swagger\Client\Model\AccessTokenRequestV2 $body Get an access token (required)
     *
     * @throws \InvalidArgumentException
     ...
     */
    protected function postOauthAccessTokenRequest($body)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling postOauthAccessToken'
            );
        }
