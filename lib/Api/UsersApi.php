...
class UsersApi
{
     ...
     * @return \Swagger\Client\Model\UserContactV2
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\UserContactV2, HTTP status code, HTTP response headers (array of strings)
     */
    public function getUsersMeWithHttpInfo()
    {
        $returnType = '\Swagger\Client\Model\UserContactV2';
        $request = $this->getUsersMeRequest();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\UserContactV2',
     ...
     */
    public function getUsersMeAsync()
    {
        return $this->getUsersMeAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getUsersMeAsyncWithHttpInfo()
    {
        $returnType = '\Swagger\Client\Model\UserContactV2';
        $request = $this->getUsersMeRequest();
     ...
     */
    protected function getUsersMeRequest()
    {
