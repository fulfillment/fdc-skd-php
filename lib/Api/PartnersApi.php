...
class PartnersApi
{
    ...
    /**
     * Operation putOrdersIdShip
     *
     * Ship an Order
     *
     * @param  \Swagger\Client\Model\OrderShipV2 $body Shipping Details (required)
     ...
     */
    public function putOrdersIdShip($body, $id)
    {
        list($response) = $this->putOrdersIdShipWithHttpInfo($body, $id);
        return $response;
    }

    /**
     * Operation putOrdersIdShipWithHttpInfo
     *
     * Ship an Order
     *
     * @param  \Swagger\Client\Model\OrderShipV2 $body Shipping Details (required)
     ...
     */
    public function putOrdersIdShipWithHttpInfo($body, $id)
    {
        $returnType = '\Swagger\Client\Model\Paths1ordersPostResponses201ContentApplication1jsonSchema';
        $request = $this->putOrdersIdShipRequest($body, $id);
    ...
    /**
     * Operation putOrdersIdShipAsync
     *
     * Ship an Order
     *
     * @param  \Swagger\Client\Model\OrderShipV2 $body Shipping Details (required)
     ...
     */
    public function putOrdersIdShipAsync($body, $id)
    {
        return $this->putOrdersIdShipAsyncWithHttpInfo($body, $id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation putOrdersIdShipAsyncWithHttpInfo
     *
     * Ship an Order
     *
     * @param  \Swagger\Client\Model\OrderShipV2 $body Shipping Details (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function putOrdersIdShipAsyncWithHttpInfo($body, $id)
    {
        $returnType = '\Swagger\Client\Model\Paths1ordersPostResponses201ContentApplication1jsonSchema';
        $request = $this->putOrdersIdShipRequest($body, $id);
    ...
    /**
     * Create request for operation 'putOrdersIdShip'
     *
     * @param  \Swagger\Client\Model\OrderShipV2 $body Shipping Details (required)
     * @param  int $id The FDC order Id (required)
     *
     ...
     */
    protected function putOrdersIdShipRequest($body, $id)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling putOrdersIdShip'
            );
        }
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling putOrdersIdShip'
            );
        }
    ...
    /**
     * Operation putOrdersIdStatus
     *
     * Update Order Status
     *
     * @param  \Swagger\Client\Model\StatusTypeSimpleV2 $body New status event (required)
     * @param  int $id The FDC order Id (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\Paths1ordersPostResponses201ContentApplication1jsonSchema
     */
    public function putOrdersIdStatus($body, $id)
    {
        list($response) = $this->putOrdersIdStatusWithHttpInfo($body, $id);
        return $response;
    }

    /**
     * Operation putOrdersIdStatusWithHttpInfo
     *
     * Update Order Status
     *
     * @param  \Swagger\Client\Model\StatusTypeSimpleV2 $body New status event (required)
     ...
     * @return array of \Swagger\Client\Model\Paths1ordersPostResponses201ContentApplication1jsonSchema, HTTP status code, HTTP response headers (array of strings)
     */
    public function putOrdersIdStatusWithHttpInfo($body, $id)
    {
        $returnType = '\Swagger\Client\Model\Paths1ordersPostResponses201ContentApplication1jsonSchema';
        $request = $this->putOrdersIdStatusRequest($body, $id);
    ...
    /**
     * Operation putOrdersIdStatusAsync
     *
     * Update Order Status
     *
     * @param  \Swagger\Client\Model\StatusTypeSimpleV2 $body New status event (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function putOrdersIdStatusAsync($body, $id)
    {
        return $this->putOrdersIdStatusAsyncWithHttpInfo($body, $id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation putOrdersIdStatusAsyncWithHttpInfo
     *
     * Update Order Status
     *
     * @param  \Swagger\Client\Model\StatusTypeSimpleV2 $body New status event (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function putOrdersIdStatusAsyncWithHttpInfo($body, $id)
    {
        $returnType = '\Swagger\Client\Model\Paths1ordersPostResponses201ContentApplication1jsonSchema';
        $request = $this->putOrdersIdStatusRequest($body, $id);
    ...
    /**
     * Create request for operation 'putOrdersIdStatus'
     *
     * @param  \Swagger\Client\Model\StatusTypeSimpleV2 $body New status event (required)
     * @param  int $id The FDC order Id (required)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function putOrdersIdStatusRequest($body, $id)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling putOrdersIdStatus'
            );
        }
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling putOrdersIdStatus'
            );
        }

        $resourcePath = '/orders/{id}/status';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
