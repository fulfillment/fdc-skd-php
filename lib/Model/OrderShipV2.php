 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class OrderShipV2 implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'OrderShip.v2';
...
'tracking_number' => 'trackingNumber'    ];
    ...
    protected static $setters = [
        'weight_override' => 'setWeightOverride',
'tracking_number' => 'setTrackingNumber'    ];
    ...
    protected static $getters = [
        'weight_override' => 'getWeightOverride',
'tracking_number' => 'getTrackingNumber'    ];
    ...
    {
        $this->container['weight_override'] = isset($data['weight_override']) ? $data['weight_override'] : null;
    ...
    /**
     * Gets weight_override
     *
     * @return float
     */
    public function getWeightOverride()
    {
        return $this->container['weight_override'];
    }

    /**
     * Sets weight_override
     *
     * @param float $weight_override Override predicted weight of package
     *
     * @return $this
     */
    public function setWeightOverride($weight_override)
    {
        $this->container['weight_override'] = $weight_override;
     ...
     *
     * @param string $tracking_number Tracking number of package
     *
     * @return $this
     */
