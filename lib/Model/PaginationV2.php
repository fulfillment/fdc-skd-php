...
/**
 * PaginationV2 Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PaginationV2 implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Pagination.v2';
...
'total' => 'getTotal'    ];
     ...
     * Sets total_pages
     *
     * @param int $total_pages Total number of pages available to request
     *
     * @return $this
     */
     ...
     * Sets current_page
     *
     * @param int $current_page Current page of the response, this will match the page paramater
     *
     * @return $this
     */
     ...
     * Sets count
     *
     * @param int $count Count of records returned in response, this will be equal to or less then the limit paramater
     *
     * @return $this
     */
     ...
     * Sets total
     *
     * @param int $total Total number of records available to request
     *
     * @return $this
     */
