 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ReturnV2 implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Return.v2';
    ...
    protected static $swaggerTypes = [
        'id' => 'int',
'rma_items' => '\Swagger\Client\Model\RmaItemV2[]',
'order' => '\Swagger\Client\Model\ReturnsArrayV2Order',
'updated_by' => '\Swagger\Client\Model\UserV2',
'created_by' => '\Swagger\Client\Model\Paths1returnsGetResponses200ContentApplication1jsonSchemaPropertiesDataItemsPropertiesUpdatedBy',
'status' => '\Swagger\Client\Model\ReturnsArrayV2Status',
'reason' => '\Swagger\Client\Model\ReturnsArrayV2Status',
'created_at' => '\DateTime',
'updated_at' => '\DateTime',
'returned_by' => 'string',
'comments' => 'string',
...
'rma_number' => 'getRmaNumber'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['rma_items'] = isset($data['rma_items']) ? $data['rma_items'] : null;
        ...
        $this->container['returned_by'] = isset($data['returned_by']) ? $data['returned_by'] : null;
     ...
     * Gets rma_items
     *
     * @return \Swagger\Client\Model\RmaItemV2[]
     */
    public function getRmaItems()
    {
        return $this->container['rma_items'];
    }

    /**
     * Sets rma_items
     *
     * @param \Swagger\Client\Model\RmaItemV2[] $rma_items rma_items
     *
     * @return $this
     */
    public function setRmaItems($rma_items)
    {
        $this->container['rma_items'] = $rma_items;
     ...
     * Gets order
     *
     * @return \Swagger\Client\Model\ReturnsArrayV2Order
     */
     ...
     * Sets order
     *
     * @param \Swagger\Client\Model\ReturnsArrayV2Order $order order
     *
     * @return $this
     */
     ...
     * Sets updated_by
     *
     * @param \Swagger\Client\Model\UserV2 $updated_by updated_by
     *
     * @return $this
     */
     ...
     * Gets created_by
     *
     * @return \Swagger\Client\Model\Paths1returnsGetResponses200ContentApplication1jsonSchemaPropertiesDataItemsPropertiesUpdatedBy
     */
     ...
     * Sets created_by
     *
     * @param \Swagger\Client\Model\Paths1returnsGetResponses200ContentApplication1jsonSchemaPropertiesDataItemsPropertiesUpdatedBy $created_by created_by
     *
     * @return $this
     */
     ...
     * Gets status
     *
     * @return \Swagger\Client\Model\ReturnsArrayV2Status
     */
     ...
     * Sets status
     *
     * @param \Swagger\Client\Model\ReturnsArrayV2Status $status status
     *
     * @return $this
     */
     ...
     * Sets reason
     *
     * @param \Swagger\Client\Model\ReturnsArrayV2Status $reason reason
     *
     * @return $this
     */
    ...
    {
        return $this->container['returned_by'];
    }

    /**
     * Sets returned_by
     *
     * @param string $returned_by returned_by
     *
     * @return $this
     */
    public function setReturnedBy($returned_by)
    {
        $this->container['returned_by'] = $returned_by;
     ...
     * Sets rma_number
     *
     * @param string $rma_number rma_number
     *
     * @return $this
     */
