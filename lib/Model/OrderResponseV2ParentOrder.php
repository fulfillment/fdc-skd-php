...
/**
 * OrderResponseV2ParentOrder Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class OrderResponseV2ParentOrder implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'OrderResponse.v2_parentOrder';
     ...
     * Sets id
     *
     * @param int $id Reference to parent `id` if order was grouped
     *
     * @return $this
     */
