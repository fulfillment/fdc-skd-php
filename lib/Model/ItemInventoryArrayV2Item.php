...
/**
 * ItemInventoryArrayV2Item Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ItemInventoryArrayV2Item implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ItemInventoryArray.v2_item';
...
'sku_reference' => 'getSkuReference'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['sku_reference'] = isset($data['sku_reference']) ? $data['sku_reference'] : null;
    }
     ...
     * Sets id
     *
     * @param int $id FDC ID for this Item
     *
     * @return $this
     */
    ...
    {
        return $this->container['sku_reference'];
    }

    /**
     * Sets sku_reference
     *
     * @param string $sku_reference Sku reference name for this item
     *
     * @return $this
     */
    public function setSkuReference($sku_reference)
    {
        $this->container['sku_reference'] = $sku_reference;
