...
/**
 * IsoCountryV2 Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class IsoCountryV2 implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'IsoCountry.v2';
...
'name' => 'getName'    ];
     ...
     * Sets iso2
     *
     * @param string $iso2 Two character ISO code
     *
     * @return $this
     */
