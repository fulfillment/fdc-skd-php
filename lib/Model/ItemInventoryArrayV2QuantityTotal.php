...
/**
 * ItemInventoryArrayV2QuantityTotal Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ItemInventoryArrayV2QuantityTotal implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ItemInventoryArray.v2_quantity_total';
    ...
    protected static $setters = [
        'available_to_promise' => 'setAvailableToPromise'    ];
    ...
    protected static $getters = [
        'available_to_promise' => 'getAvailableToPromise'    ];
    ...
    {
        $this->container['available_to_promise'] = isset($data['available_to_promise']) ? $data['available_to_promise'] : null;
    }
    ...
    /**
     * Gets available_to_promise
     *
     * @return int
     */
    public function getAvailableToPromise()
    {
        return $this->container['available_to_promise'];
    }

    /**
     * Sets available_to_promise
     *
     * @param int $available_to_promise Number of items that are available to be used in an order
     *
     * @return $this
     */
    public function setAvailableToPromise($available_to_promise)
    {
        $this->container['available_to_promise'] = $available_to_promise;
