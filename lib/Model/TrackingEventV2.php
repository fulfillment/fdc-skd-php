...
/**
 * TrackingEventV2 Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TrackingEventV2 implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TrackingEvent.v2';
    ...
    protected static $swaggerTypes = [
        'event_source' => 'string',
'event_location' => '\Swagger\Client\Model\Paths1trackGetResponses200ContentApplication1jsonSchemaPropertiesOrigin',
...
'event_category_code' => 'setEventCategoryCode',
...
'event_category_code' => 'getEventCategoryCode',
...
'event_status' => 'getEventStatus'    ];
    ...
    const EVENT_SOURCE_CARRIER = 'carrier';
const EVENT_SOURCE_INTERNAL = 'internal';
    ...
    {
        return [
            self::EVENT_SOURCE_CARRIER,
self::EVENT_SOURCE_INTERNAL,        ];
    }
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['event_category_code'] = isset($data['event_category_code']) ? $data['event_category_code'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['event_source']) && !in_array($this->container['event_source'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value for 'event_source', must be one of '%s'",
    ...
    {
        $allowedValues = $this->getEventSourceAllowableValues();
        if (!is_null($event_source) && !in_array($event_source, $allowedValues, true)) {
     ...
     * Sets event_location
     *
     * @param \Swagger\Client\Model\Paths1trackGetResponses200ContentApplication1jsonSchemaPropertiesOrigin $event_location event_location
     *
     * @return $this
     */
     ...
     *
     * @param \DateTime $event_date_time event_date_time
     *
     * @return $this
     */
    ...
    /**
     * Gets event_category_code
     *
     * @return int
     */
    public function getEventCategoryCode()
    {
        return $this->container['event_category_code'];
    }

    /**
     * Sets event_category_code
     *
     * @param int $event_category_code event_category_code
     *
     * @return $this
     */
    public function setEventCategoryCode($event_category_code)
    {
        $this->container['event_category_code'] = $event_category_code;
     ...
     * Sets event_category
     *
     * @param string $event_category event_category
     *
     * @return $this
     */
