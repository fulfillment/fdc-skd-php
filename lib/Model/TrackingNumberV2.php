...
/**
 * TrackingNumberV2 Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TrackingNumberV2 implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TrackingNumber.v2';
    ...
    protected static $swaggerTypes = [
        'carrier' => '\Swagger\Client\Model\UserV2',
'barcode_scan_value' => 'string',
'value' => 'string'    ];
...
'value' => 'value'    ];
    ...
    protected static $setters = [
        'carrier' => 'setCarrier',
'barcode_scan_value' => 'setBarcodeScanValue',
'value' => 'setValue'    ];
    ...
    protected static $getters = [
        'carrier' => 'getCarrier',
'barcode_scan_value' => 'getBarcodeScanValue',
'value' => 'getValue'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['barcode_scan_value'] = isset($data['barcode_scan_value']) ? $data['barcode_scan_value'] : null;
     ...
     * Sets carrier
     *
     * @param \Swagger\Client\Model\UserV2 $carrier carrier
     *
     * @return $this
     */
    ...
    /**
     * Gets barcode_scan_value
     *
     * @return string
     */
    public function getBarcodeScanValue()
    {
        return $this->container['barcode_scan_value'];
    }

    /**
     * Sets barcode_scan_value
     *
     * @param string $barcode_scan_value The computer readable alternative to the human readable
     *
     * @return $this
     */
    public function setBarcodeScanValue($barcode_scan_value)
    {
        $this->container['barcode_scan_value'] = $barcode_scan_value;
     ...
     * Sets value
     *
     * @param string $value The human readable tracking number recipients (consignee) expect
     *
     * @return $this
     */
