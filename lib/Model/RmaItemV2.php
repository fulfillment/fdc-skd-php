 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class RmaItemV2 implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RmaItem.v2';
    ...
    protected static $swaggerTypes = [
        'id' => 'int',
'non_restocked_reason' => '\Swagger\Client\Model\ReturnsArrayV2NonRestockedReason',
'quantity_shipped' => 'int',
'quantity_returned' => 'int',
'quantity_restocked' => 'int',
'quantity_expected' => 'int',
'comments' => 'string',
'item' => '\Swagger\Client\Model\ReturnsArrayV2Item'    ];
...
'item' => 'item'    ];
    ...
    protected static $setters = [
        'id' => 'setId',
'non_restocked_reason' => 'setNonRestockedReason',
...
'item' => 'setItem'    ];
    ...
    protected static $getters = [
        'id' => 'getId',
'non_restocked_reason' => 'getNonRestockedReason',
...
'item' => 'getItem'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['non_restocked_reason'] = isset($data['non_restocked_reason']) ? $data['non_restocked_reason'] : null;
    ...
    /**
     * Gets non_restocked_reason
     *
     * @return \Swagger\Client\Model\ReturnsArrayV2NonRestockedReason
     */
    public function getNonRestockedReason()
    {
        return $this->container['non_restocked_reason'];
    }

    /**
     * Sets non_restocked_reason
     *
     * @param \Swagger\Client\Model\ReturnsArrayV2NonRestockedReason $non_restocked_reason non_restocked_reason
     *
     * @return $this
     */
    public function setNonRestockedReason($non_restocked_reason)
    {
        $this->container['non_restocked_reason'] = $non_restocked_reason;
     ...
     *
     * @param int $quantity_restocked quantity_restocked
     *
     * @return $this
     */
     ...
     * Gets item
     *
     * @return \Swagger\Client\Model\ReturnsArrayV2Item
     */
     ...
     * Sets item
     *
     * @param \Swagger\Client\Model\ReturnsArrayV2Item $item item
     *
     * @return $this
     */
