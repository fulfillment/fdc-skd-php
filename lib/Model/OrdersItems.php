 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class OrdersItems implements ModelInterface, ArrayAccess
{
...
'declared_value' => 'getDeclaredValue'    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['declared_value'] === null) {
            $invalidProperties[] = "'declared_value' can't be null";
        }
     ...
     * Sets declared_value
     *
     * @param string $declared_value Using USD, a per unit value of a single SKU. If your declaring a kit this is the sum total for a single kit. In both scenarios we will multiply the `declaredValue` against the `quantity` for customs declaration.
     *
     * @return $this
     */
