...
/**
 * ReturnsItems Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ReturnsItems implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'returns_items';
...
'quantity_expected' => 'getQuantityExpected'    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['quantity_expected'] === null) {
            $invalidProperties[] = "'quantity_expected' can't be null";
        }
